...
export const createNewIssue = createTrigger({
    auth: AddonAuth | undefined
    name: string, // Unique name across the addon.
...
The Context object contains multiple helpful addons of information and tools that can be useful while developing.
