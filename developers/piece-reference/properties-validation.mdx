...
NRAI uses Zod for runtime validation of addon properties. Zod provides a powerful schema validation system that helps ensure your addon receives valid inputs.

To use Zod validation in your addon, first import the validation helper and Zod:
...
import { propsValidation } from '@NRAI/addons-common';
import { z } from 'zod';
