...
<Steps>
    ...
    <Step title="Fill in the Client ID & Client Secret in NRAI"></Step>
...
<Steps>
    ...
    <Step title="Copy the Client ID and Client Secret and fill them in NRAI"></Step>
    <Step title="Click Finish"></Step>
</Steps>
...
<Steps>
    ...
    <Step title="Fill in Audience URI (SP Entity ID) with 'NRAI'"></Step>
...
<Steps>
    ...
    <Step title="Copy the ACS URL from NRAI and paste it in the ACS urls">
