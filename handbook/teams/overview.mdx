...
<CardGroup cols={2}>
  ...
  <Card title="Platform" icon="layer-group" href="/handbook/teams/platform" color="#34495E">
    Build and maintain infrastructure and management systems that power NRAI
  </Card>
    <Card title="Addons" icon="puzzle-addon" href="/handbook/teams/addons" color="#F1C40F">
    Build and manage integration addons to connect with external services
  </Card>
  ...
  <Card title="Sales" icon="handshake" href="/handbook/teams/sales" color="#27AE60">
    Grow revenue by selling NRAI to businesses
  </Card>
</CardGroup>
