...
description: "Guide for creating database migrations in NRAI"
icon: "database"
---

NRAI uses TypeORM as its database driver in Node.js. We support two database types across different editions of our platform.
...
- Developers creating addons who want a quick setup
