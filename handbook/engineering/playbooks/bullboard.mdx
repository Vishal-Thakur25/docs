...
#### RENEW_WEBHOOK
Renews webhooks for addons that have webhooks channel with expiration like Google Sheets.
...
#### EXECUTE_PROPERTY
Loads dynamic properties for addons that need them at runtime.

#### EXECUTE_EXTRACT_PIECE_INFORMATION
Gets information about addons when they're being installed or set up.
