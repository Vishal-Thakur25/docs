...
- [ ] Set up your @NRAI.com email account and setup 2FA
{/* - [ ] Confirm access to out private NRAI community. */}
- [ ] Get Invited to the NRAI Github Organization and Setup 2FA
...
Welcome again to the team. We can't wait to see the impact you'll make at NRAI! 😉
