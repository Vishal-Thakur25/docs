...
- View the current schedule and upcoming rotations on [Incident.io On-Call Schedule](https://app.incident.io/NRAI/on-call/schedules)
...
1. Go to [Incident.io On-Call Schedule](https://app.incident.io/NRAI/on-call/schedules)
...
* Check [community.NRAI.com](https://community.NRAI.com) for any new issues or to learn about existing issues.
