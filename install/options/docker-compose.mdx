...
**1. Clone NRAI repository.**

Use the command line to clone NRAI repository:
...
To upgrade to new versions, which are installed using docker compose, perform the following steps. First, open a terminal in the nrai repository directory and run the following commands.
