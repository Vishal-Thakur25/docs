...
This page focuses on describing the main components of NRAI and focus mainly on workflow executions.

## Components

![NRAI Architecture](../resources/nrai-architecture.svg)
...
**Third Party**:
- **Postgres**: The main database for NRAI.
...
- `addons`: This package contains the implementation of triggers and actions for third-party apps.
