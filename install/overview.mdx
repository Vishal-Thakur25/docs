...
title: "Overview"
icon: "hand-wave"
description: "Introduction to the different ways to install NRAI"
---

NRAI Community Edition can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.
...
Deploy NRAI as a single Docker container using the SQLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose">
    Deploy NRAI with **Redis** and **PostgreSQL** setup.
  </Card>
...
<CardGroup cols={2}>
  ...
  } href="https://www.pikapods.com/pods?run=NRAI">
    Instantly run on PikaPods from $2.9/month.
  </Card>

  <Card title="NRAI Cloud" icon="cloud" href="https://nrai.io">
    Deploy NRAI easily with our cloud platform.
  </Card>
...
<CardGroup cols={2}>
  <Card title="NRAI Cloud" icon="cloud" color="##5155D7" href="https://cloud.nrai.io/">
