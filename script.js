...
inkeepScript.addEventListener("load", function () {
  ...
  const sharedConfig = {
    ...
    aiChatSettings: {
      chatSubjectName: "NRAI",
      botAvatarSrcUrl:
        "https://storage.googleapis.com/organization-image-assets/NRAI-botAvatarSrcUrl-1709136841325.svg",
      botAvatarDarkSrcUrl:
        "https://storage.googleapis.com/organization-image-assets/NRAI-botAvatarDarkSrcUrl-1709136840372.svg",
      getHelpCallToActions: [
        
       
        {
          name: "GitHub",
          url: "https://github.com/NRAI/NRAI",
          icon: {
            builtIn: "FaGithub",
          },
        },
