...
- Keep the software unopinionated and unlock niche use cases by making it extensible through addons.

## 🧩 Keep It Extensible

- Automation addons framework has minimal abstraction and allow you to extend for any usecase.
